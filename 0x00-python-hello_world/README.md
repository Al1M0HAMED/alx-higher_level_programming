...
this is my first python project, I began practicing using python, printing text
and variables, and indexing and slicing strings and implemented an algorithm in c.
